...
.event-hero .breadcrumb {{ font-size: 0.72rem; opacity: 0.85; margin-bottom: 0.35rem; color: #fff; }}
.event-hero .breadcrumb a {{ color: #ffd700; text-decoration: none; }}
.event-hero h1 {{ font-size: 1.25rem; margin: 0 0 0.3rem; line-height: 1.25; color: #fff; }}
.event-hero .event-period {{ font-size: 0.92rem; font-weight: 700; margin-bottom: 0.25rem; color: #ffd700; }}
.event-hero .event-area {{ display: inline-block; padding: 0.15rem 0.6rem; border-radius: 999px; background: rgba(255,255,255,0.15); font-size: 0.72rem; color: #fff; }}
...
.events-hero {{ background: linear-gradient(135deg, #8b0000 0%, #c41e3a 100%); color: #fff; padding: 0.85rem 1.25rem 1rem; text-align: center; }}
.events-hero .breadcrumb {{ font-size: 0.72rem; opacity: 0.85; margin-bottom: 0.35rem; color: #fff; }}
.events-hero .breadcrumb a {{ color: #ffd700; text-decoration: none; }}
.events-hero h1 {{ margin: 0; font-size: 1.2rem; color: #fff; line-height: 1.2; }}
.events-hero p {{ margin: 0.2rem 0 0; opacity: 0.9; color: #fff; font-size: 0.78rem; }}
