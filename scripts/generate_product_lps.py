...
PRODUCTS = [
    ...
    },
    {
        ...
        "size_variants": [
            ...
            {"label": "280g", "price_original": 1600, "price_hp": 1480},
            {"label": "1kg", "price_original": 5714, "price_hp": 4980},
        ],
    },
]
...
<main class="pp-body">
  ...
  <section class="pp-section">
    ...
    <p class="pp-nutrition-note">※ HP価格は催事リピーター 5%OFF 適用後の表示価格です。内容量: {escape(p['weight'])}</p>{variants_html}
  </section>
