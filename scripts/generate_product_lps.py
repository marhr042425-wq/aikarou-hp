...
.pp-hero {{ background: linear-gradient(135deg, #8b0000 0%, #c41e3a 100%); color: #fff; padding: 2.5rem 1.5rem 2rem; text-align: center; }}
.pp-hero .breadcrumb {{ font-size: 0.85rem; opacity: 0.85; margin-bottom: 1rem; color: #fff; }}
.pp-hero .breadcrumb a {{ color: #ffd700; text-decoration: none; }}
.pp-hero h1 {{ margin: 0; font-size: 1.85rem; color: #fff; }}
.pp-hero .en {{ font-size: 0.9rem; opacity: 0.85; margin-top: 0.25rem; letter-spacing: 0.1em; }}
.pp-hero .tagline {{ margin-top: 1rem; color: #ffd700; font-size: 1.05rem; }}
...
.pi-hero {{ background: linear-gradient(135deg, #8b0000 0%, #c41e3a 100%); color: #fff; padding: 3rem 1.5rem; text-align: center; }}
.pi-hero .breadcrumb {{ font-size: 0.85rem; opacity: 0.85; margin-bottom: 1rem; color: #fff; }}
.pi-hero .breadcrumb a {{ color: #ffd700; text-decoration: none; }}
.pi-hero h1 {{ margin: 0; font-size: 2rem; color: #fff; }}
.pi-hero p {{ margin: 0.5rem 0 0; opacity: 0.9; color: #fff; }}
